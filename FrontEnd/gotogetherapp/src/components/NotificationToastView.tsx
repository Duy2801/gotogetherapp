...
export const CustomNotificationToast = ({ props }: any) => {
  const { backgroundColor, icon, text1, text2, onClose, onPress } = props;

  return (
    <TouchableOpacity activeOpacity={0.9} onPress={() => onPress && onPress()} style={[styles.container, { backgroundColor }]}>
      <View style={styles.content}>
        <FontAwesome6 name={icon} size={18} color="#FFFFFF" iconStyle="solid" style={styles.icon} />
...
export default NotificationToastView;
